...
#' }
# validateUrl(url = "https://soda.demo.socrata.com/resource/4334-bgaj", app_token="ew2rEMuESuzWPqMkyPfOSGJgE")
# validateUrl(url = "https://soda.demo.socrata.com/resource/4334-bgaj.json", app_token="ew2rEMuESuzWPqMkyPfOSGJgE")
# validateUrl(url = "https://soda.demo.socrata.com/dataset/USGS-Earthquake-Reports/4334-bgaj.csv?$$app_token=ew2rEMuESuzWPqMkyPfOSGJgE")
# &$limit=5&$offset=0
#' @export
